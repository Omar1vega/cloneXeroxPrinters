...
def clonePrinter(printerInfoList):
    ...
    with requests.Session() as s:
        ...
        loginData = {'_fun_function':'HTTP_Authenticate_fn','NextPage':'/properties/authentication/luidLogin.php','webUsername':user,'webPassword':password,'frmaltDomain':'default'}
        ...
        fileName = deptName+'/'+datetime.datetime.today().strftime('%Y.%m.%d_')+getModel(printer).replace(' ', '')+'_'+printer+'.dlm'
